...
func TestMarshalUnmarshalfilesAsStructs(t *testing.T) {
	v := filesAsStructs{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgfilesAsStructs(b *testing.B) {
	v := filesAsStructs{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgfilesAsStructs(b *testing.B) {
	v := filesAsStructs{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalfilesAsStructs(b *testing.B) {
	v := filesAsStructs{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodefilesAsStructs(t *testing.T) {
	v := filesAsStructs{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodefilesAsStructs Msgsize() is inaccurate")
	}
...
func BenchmarkEncodefilesAsStructs(b *testing.B) {
	v := filesAsStructs{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodefilesAsStructs(b *testing.B) {
	v := filesAsStructs{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
