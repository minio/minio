...
func TestURLString(t *testing.T) {
	testCases := []struct {
		...
		{URL{Scheme: "https", Host: "play.minio.io:80"}, "https://play.min.io:80"},
...
func TestURLMarshalJSON(t *testing.T) {
	testCases := []struct {
		...
		{URL{Scheme: "https", Host: "play.minio.io:0"}, []byte(`"https://play.min.io:0"`), false},
...
func TestURLUnmarshalJSON(t *testing.T) {
	testCases := []struct {
		...
		{[]byte(`"https://play.min.io:0"`), &URL{Scheme: "https", Host: "play.minio.io:0"}, false},
...
func TestParseURL(t *testing.T) {
	testCases := []struct {
		...
		{"https://play.min.io:0", &URL{Scheme: "https", Host: "play.minio.io:0"}, false},
