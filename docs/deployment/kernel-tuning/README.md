...
All these system level tunings are conveniently packaged in [shell script](https://github.com/minio/minio/blob/master/docsk/deployment/kernel-tuning/sysctl.sh). Please review the shell script for our recommendations.
