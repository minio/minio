...
First we will need to install golang, follow [https://docs.minio.io/docs/how-to-install-golang](how to install golang) guide. We also need to install GNU make:
