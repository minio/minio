...
MinIO requires a 7.x series version of Elasticsearch. This is the latest major release series at the time of writing. Elasticsearch provides version upgrade migration guidelines [here](https://www.elastic.co/guide/en/elasticsearch/reference/current/setup-upgrade.html).
    ...
    "hits" : [
      {
        "_index" : "minio_events",
        "_type" : "_doc",
        "_id" : "p6Ki67qy3lCiC8S6O7Sqg45IYNdXdtxyGnAfASuSU2c=",
        "_score" : 1.0,
        "_source" : {
          "Records" : [
            {
              ...
              "awsRegion" : "",
              "eventTime" : "2021-04-12T23:12:14.234Z",
              ...
              "responseElements" : {
                "content-length" : "0",
                "x-amz-request-id" : "16753F34204948DC",
                "x-minio-deployment-id" : "49132abc-5b60-4a46-8f59-1057479eb299",
                "x-minio-origin-endpoint" : "http://192.168.43.230:9000"
              },
              "s3" : {
                "s3SchemaVersion" : "1.0",
                ...
                "object" : {
                  "key" : "myphoto.jpg",
                  "size" : 288239,
                  "eTag" : "b98fa55ab8dd252bfc926091232075e5",
                  "contentType" : "image/jpeg",
                  "userMetadata" : {
                    "content-type" : "image/jpeg"
                  },
                  "sequencer" : "16753F34210C7FA5"
                }
              },
              "source" : {
                "host" : "127.0.0.1",
                "port" : "",
                "userAgent" : "MinIO (linux; amd64) minio-go/v7.0.11 mc/RELEASE.2021-03-23T05-46-11Z"
              }
            }
          ]
        }
...
In the `namespace` format the document ID is a hash of the bucket and object name. In case `access` format was used, the document ID would be automatically generated by Elasticsearch.
