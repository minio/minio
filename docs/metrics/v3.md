...
### `/api/bucket/replication`

| Name                                       | Type      | Help                                                                                        | Labels                             |
|--------------------------------------------|-----------|---------------------------------------------------------------------------------------------|------------------------------------|
| `last_hour_failed_bytes`                   | `gauge`   | Total number of bytes failed at least once to replicate in the last hour on a bucket        | `bucket`                           |
| `last_hour_failed_count`                   | `gauge`   | Total number of objects which failed replication in the last hour on a bucket               | `bucket`                           |
| `last_minute_failed_bytes`                 | `gauge`   | Total number of bytes failed at least once to replicate in the last full minute on a bucket | `bucket`                           |
| `last_minute_failed_count`                 | `gauge`   | Total number of objects which failed replication in the last full minute on a bucket        | `bucket`                           |
| `latency_ms`                               | `gauge`   | Replication latency on a bucket in milliseconds                                             | `bucket,operation,range,targetArn` |
| `proxied_delete_tagging_requests_total`    | `counter` | Number of DELETE tagging requests proxied to replication target                             | `bucket`                           |
| `proxied_get_requests_failures`            | `counter` | Number of failures in GET requests proxied to replication target                            | `bucket`                           |
| `proxied_get_requests_total`               | `counter` | Number of GET requests proxied to replication target                                        | `bucket`                           |
| `proxied_get_tagging_requests_failures`    | `counter` | Number of failures in GET tagging requests proxied to replication target                    | `bucket`                           |
| `proxied_get_tagging_requests_total`       | `counter` | Number of GET tagging requests proxied to replication target                                | `bucket`                           |
| `proxied_head_requests_failures`           | `counter` | Number of failures in HEAD requests proxied to replication target                           | `bucket`                           |
| `proxied_head_requests_total`              | `counter` | Number of HEAD requests proxied to replication target                                       | `bucket`                           |
| `proxied_put_tagging_requests_failures`    | `counter` | Number of failures in PUT tagging requests proxied to replication target                    | `bucket`                           |
| `proxied_put_tagging_requests_total`       | `counter` | Number of PUT tagging requests proxied to replication target                                | `bucket`                           |
| `sent_bytes`                               | `counter` | Total number of bytes replicated to the target                                              | `bucket`                           |
| `sent_count`                               | `counter` | Total number of bytes replicated to this bucket from another source bucket                  | `bucket`                           |
| `total_failed_bytes`                       | `counter` | Total number of bytes failed at least once to replicate since server start                  | `bucket`                           |
| `total_failed_count`                       | `counter` | Total number of objects which failed replication since server start                         | `bucket`                           |
| `proxied_delete_tagging_requests_failures` | `counter` | Number of failures in DELETE tagging requests proxied to replication target                 | `bucket`                           |
