...
Edit config.json and set `openid` with the following

```
"openid": {
  "configURL": "http://localhost:8080/auth/realms/demo/.well-known/openid-configuration",
  "jwks": {
    "url": "http://localhost:8080/auth/realms/demo/protocol/openid-connect/certs"
  },
  "policyClaimPrefix": ""
}
```

Update minio config and restart
