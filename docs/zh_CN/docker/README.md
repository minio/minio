...
分布式Minio可以通过 [Docker Compose](https://docs.minio.io/docs/deploy-minio-on-docker-compose) 或者 [Swarm mode](https://docs.minio.io/docs/deploy-minio-on-docker-swarm)进行部署。这两者之间的主要区别是Docker Compose创建了单个主机，多容器部署，而Swarm模式创建了一个多主机，多容器部署。
...
* [在Docker Compose上部署Minio](https://docs.minio.io/docs/deploy-minio-on-docker-compose)
* [在Docker Swarm上部署Minio](https://docs.minio.io/docs/deploy-minio-on-docker-swarm)
* [分布式Minio快速入门](https://docs.minio.io/docs/distributed-minio-quickstart-guide)
* [Minio纠删码模式快速入门](https://docs.minio.io/docs/minio-erasure-code-quickstart-guide)
