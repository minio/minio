...
## 了解更多
- [`mc` 命令行接口](https://docs.minio.io/docs/minio-client-quickstart-guide)
- [`aws` 命令行接口](https://docs.minio.io/docs/aws-cli-with-minio)
- [`minfs` 文件系统接口](http://docs.minio.io/docs/minfs-quickstart-guide)
