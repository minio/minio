...
func (api objectAPIHandlers) loadNotificationConfig(bucket string) (nConfig notificationConfig, err error) {
	...
	// Unmarshalling succeeded now proceed to enable notification.
	if err = enableNotification(nConfig); err != nil {
		return notificationConfig{}, err
	}
...
func (api objectAPIHandlers) PutBucketNotificationHandler(w http.ResponseWriter, r *http.Request) {
	...
	// Validation succeeded now proceed to enable notification.
