...
func testMakeBucket(obj ObjectLayer, instanceType string, c TestErrHandler) {
	err := obj.MakeBucket(globalMinioDefaultRegion, "bucket-unknown")
	if err != nil {
...
func testPaging(obj ObjectLayer, instanceType string, c TestErrHandler) {
	obj.MakeBucket(globalMinioDefaultRegion, "bucket")
...
func testBucketRecreateFails(obj ObjectLayer, instanceType string, c TestErrHandler) {
	err := obj.MakeBucket(globalMinioDefaultRegion, "string")
	if err != nil {
		c.Fatalf("%s: <ERROR> %s", instanceType, err)
	}
	err = obj.MakeBucket(globalMinioDefaultRegion, "string")
...
func testListBuckets(obj ObjectLayer, instanceType string, c TestErrHandler) {
	...
	err = obj.MakeBucket(globalMinioDefaultRegion, "bucket1")
	if err != nil {
		c.Fatalf("%s: <ERROR> %s", instanceType, err)
	}
	...
	err = obj.MakeBucket(globalMinioDefaultRegion, "bucket2")
	if err != nil {
		c.Fatalf("%s: <ERROR> %s", instanceType, err)
	}
	...
	err = obj.MakeBucket(globalMinioDefaultRegion, "bucket22")
	if err != nil {
		c.Fatalf("%s: <ERROR> %s", instanceType, err)
	}
