...
func testObjectQuorumFromMeta(obj ObjectLayer, instanceType string, dirs []string, t TestErrHandler) {
	...
	parts1, errs1 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object1, "null"))
	...
	parts2, errs2 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object2, "null"))
	...
	parts3, errs3 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object3, "null"))
	...
	parts4, errs4 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object4, "null"))
	...
	parts5, errs5 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object5, "null"))
	...
	parts6, errs6 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object6, "null"))
	...
	parts7, errs7 := readAllXLMetadata(context.Background(), xlDisks, bucket, pathJoin(object7, "null"))
