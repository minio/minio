...
func parseXLObjectVersionID(xlMetaBuf []byte) string {
	return gjson.GetBytes(xlMetaBuf, "objectVersionID").String()
}
...
func xlVersioningV1UnmarshalJSON(ctx context.Context, xlVersioningBuf []byte) (xlVersioning xlVersioningV1, e error) {
	...
	xlVersioning.ObjectVersionID = parseXLObjectVersionID(xlVersioningBuf)
	// obtain modtime.
