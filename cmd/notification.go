...
func NewNotificationSys(cfg serverConfig, endpoints EndpointList) *NotificationSys {
	targetList, err := notify.GetNotificationTargets(config.Config(cfg), GlobalServiceDoneCh, globalRootCAs)
	if err != nil {
