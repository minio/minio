...
func testListObjects(obj ObjectLayer, instanceType string, t TestErrHandler) {
	...
	resultCases := []ListObjectsInfo{
		...
		// Testing for listing all objects in the bucket, (testCase 20,21,22).
		{
			...
			Objects: []ObjectInfo{
				...
				{Name: "Asia/India/Karnataka/"},
				{Name: "Asia/India/Karnataka/Bangalore/"},
				...
				{Name: "newzen/"},
				{Name: "newzen/zen/"},
				{Name: "newzen/zen/recurse/"},
				{Name: "newzen/zen/recurse/again/"},
				{Name: "newzen/zen/recurse/again/again/"},
				{Name: "newzen/zen/recurse/again/again/again/"},
	...
	testCases := []struct {
		...
		{"test-bucket-list-object", "", "", "", 20, resultCases[0], nil, true},
		...
		{"test-bucket-list-object", "", "", "", 10, resultCases[1], nil, true},
		{"test-bucket-list-object", "", "", "", 9, resultCases[2], nil, true},
		{"test-bucket-list-object", "", "", "", 8, resultCases[3], nil, true},
		{"test-bucket-list-object", "", "", "", 1, resultCases[4], nil, true},
		// Testing with prefix (25-28).
		{"test-bucket-list-object", "new", "", "", 9, resultCases[5], nil, true},
		{"test-bucket-list-object", "new", "", "", 9, resultCases[5], nil, true},
		{"test-bucket-list-object", "new", "", "", 9, resultCases[5], nil, true},
		...
		{"test-bucket-list-object", "", "newPrefix0", "", 11, resultCases[9], nil, true},
		{"test-bucket-list-object", "", "newPrefix1", "", 10, resultCases[10], nil, true},
		{"test-bucket-list-object", "", "obj0", "", 2, resultCases[11], nil, true},
		{"test-bucket-list-object", "", "obj1", "", 1, resultCases[12], nil, true},
		{"test-bucket-list-object", "", "man", "", 12, resultCases[13], nil, true},
		...
		{"test-bucket-list-object", "", "Abc", "", 20, resultCases[14], nil, true},
		// Marker is to a hierarhical value (38-39).
		{"test-bucket-list-object", "", "Asia/India/India-summer-photos-1", "", 16, resultCases[15], nil, true},
		{"test-bucket-list-object", "", "Asia/India/Karnataka/Bangalore/Koramangala/pics", "", 12, resultCases[16], nil, true},
		...
		{"test-bucket-list-object", "new", "newPrefix0", "", 8, resultCases[22], nil, true},
