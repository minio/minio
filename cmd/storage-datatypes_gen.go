...
func (z *FileInfo) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	z.MoreRecent, err = dc.ReadInt()
	if err != nil {
		err = msgp.WrapError(err, "MoreRecent")
		return
	}
...
func (z *FileInfo) MarshalMsg(b []byte) (o []byte, err error) {
	...
	o = msgp.AppendInt(o, z.MoreRecent)
...
func (z *FileInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	z.MoreRecent, bts, err = msgp.ReadIntBytes(bts)
	if err != nil {
		err = msgp.WrapError(err, "MoreRecent")
		return
	}
