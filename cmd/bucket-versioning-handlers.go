...
// PutBucketVersioniongHandler - This HTTP handler stores given bucket versioning configuration as per
...
func (api objectAPIHandlers) PutBucketVersioningHandler(w http.ResponseWriter, r *http.Request) {
	...
	//FIXME: check if get versioniong has anything to do with policy configuration
