...
func TestMarshalUnmarshalSelfPoolExpand(t *testing.T) {
	v := SelfPoolExpand{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgSelfPoolExpand(b *testing.B) {
	v := SelfPoolExpand{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgSelfPoolExpand(b *testing.B) {
	v := SelfPoolExpand{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalSelfPoolExpand(b *testing.B) {
	v := SelfPoolExpand{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeSelfPoolExpand(t *testing.T) {
	v := SelfPoolExpand{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeSelfPoolExpand Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeSelfPoolExpand(b *testing.B) {
	v := SelfPoolExpand{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeSelfPoolExpand(b *testing.B) {
	v := SelfPoolExpand{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
