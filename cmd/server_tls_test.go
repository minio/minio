...
var _ = Suite(&TestSuiteTLS{serverType: "FS"})

// Init and run test on XL backend.
var _ = Suite(&TestSuiteTLS{serverType: "XL"})
...
func (s *TestSuiteTLS) SetUpSuite(c *C) {
...
func (s *TestSuiteTLS) TearDownSuite(c *C) {
	s.testServer.Stop()
}

func (s *TestSuiteTLS) TestAuth(c *C) {
...
func (s *TestSuiteTLS) TestBucketSQSNotification(c *C) {
...
func (s *TestSuiteTLS) TestBucketPolicy(c *C) {
...
func (s *TestSuiteTLS) TestDeleteBucket(c *C) {
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestDeleteBucketNotEmpty(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestListenBucketNotificationHandler(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
...
func (s *TestSuiteTLS) TestDeleteMultipleObjects(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestDeleteObject(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestNonExistentBucket(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestEmptyObject(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestBucket(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestObjectGetAnonymous(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestObjectGet(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	buffer := bytes.NewReader([]byte("hello world"))
	// HTTP request to create the bucket.
...
func (s *TestSuiteTLS) TestMultipleObjects(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestNotImplemented(c *C) {
	// Generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestHeader(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestPutBucket(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestCopyObject(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestPutObject(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestListBuckets(c *C) {
...
func (s *TestSuiteTLS) TestValidateSignature(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestSHA256Mismatch(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestPutObjectLongName(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
// TestNotBeAbleToCreateObjectInNonexistentBucket - Validates the error response
// on an attempt to upload an object into a non-existent bucket.
func (s *TestSuiteTLS) TestNotBeAbleToCreateObjectInNonexistentBucket(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestHeadOnObjectLastModified(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestHeadOnBucket(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
...
func (s *TestSuiteTLS) TestContentTypePersists(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestPartialContent(c *C) {
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestListObjectsHandler(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestListObjectsHandlerErrors(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestPutBucketErrors(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestGetObjectLarge10MiB(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestGetObjectLarge11MiB(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestGetPartialObjectMisAligned(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestGetPartialObjectLarge11MiB(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestGetPartialObjectLarge10MiB(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestGetObjectErrors(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
...
func (s *TestSuiteTLS) TestGetObjectRangeErrors(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestObjectMultipartAbort(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestBucketMultipartList(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
...
func (s *TestSuiteTLS) TestValidateObjectMultipartUploadID(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestObjectMultipartListError(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestObjectValidMD5(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
...
func (s *TestSuiteTLS) TestObjectMultipart(c *C) {
	// generate a random bucket name.
	bucketName := getRandomBucketName()
	// HTTP request to create the bucket.
	request, err := newTestSignedRequestV4("PUT", getMakeBucketURL(s.endPoint, bucketName),
