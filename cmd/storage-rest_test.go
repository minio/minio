...
func testStorageAPIDiskInfo(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		_, err := storage.DiskInfo(context2.TODO())
		expectErr := (err != nil)
...
func testStorageAPIMakeVol(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		err := storage.MakeVol(context2.TODO(), testCase.volumeName)
		expectErr := (err != nil)
...
func testStorageAPIListVols(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		for _, volumeName := range testCase.volumeNames {
			err := storage.MakeVol(context2.TODO(), volumeName)
			if err != nil {
				t.Fatalf("unexpected error %v", err)
			}
		}

		result, err := storage.ListVols(context2.TODO())
		expectErr := (err != nil)
...
func testStorageAPIStatVol(t *testing.T, storage StorageAPI) {
	err := storage.MakeVol(context2.TODO(), "foo")
	if err != nil {
		t.Fatalf("unexpected error %v", err)
	}
	...
	for i, testCase := range testCases {
		result, err := storage.StatVol(context2.TODO(), testCase.volumeName)
		expectErr := (err != nil)
...
func testStorageAPIDeleteVol(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		err := storage.DeleteVol(context2.TODO(), testCase.volumeName, false)
		expectErr := (err != nil)
...
func testStorageAPICheckFile(t *testing.T, storage StorageAPI) {
	...
	err = storage.AppendFile(context2.TODO(), "foo", pathJoin("myobject", xlStorageFormatFile), []byte("foo"))
	if err != nil {
		t.Fatalf("unexpected error %v", err)
	}
	...
	for i, testCase := range testCases {
		err := storage.CheckFile(context2.TODO(), testCase.volumeName, testCase.objectName)
		expectErr := (err != nil)
...
func testStorageAPIListDir(t *testing.T, storage StorageAPI) {
	...
	err = storage.AppendFile(context2.TODO(), "foo", "path/to/myobject", []byte("foo"))
	if err != nil {
		t.Fatalf("unexpected error %v", err)
	}
	...
	for i, testCase := range testCases {
		result, err := storage.ListDir(context2.TODO(), testCase.volumeName, testCase.prefix, -1)
		expectErr := (err != nil)
...
func testStorageAPIReadAll(t *testing.T, storage StorageAPI) {
	...
	err = storage.AppendFile(context2.TODO(), "foo", "myobject", []byte("foo"))
	if err != nil {
		t.Fatalf("unexpected error %v", err)
	}
	...
	for i, testCase := range testCases {
		result, err := storage.ReadAll(context2.TODO(), testCase.volumeName, testCase.objectName)
		expectErr := (err != nil)
...
func testStorageAPIReadFile(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		...
		_, err := storage.ReadFile(context2.TODO(), testCase.volumeName, testCase.objectName, testCase.offset, result, nil)
		expectErr := (err != nil)
...
func testStorageAPIAppendFile(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		err := storage.AppendFile(context2.TODO(), testCase.volumeName, testCase.objectName, testCase.data)
		expectErr := (err != nil)
...
func testStorageAPIDeleteFile(t *testing.T, storage StorageAPI) {
	...
	for i, testCase := range testCases {
		err := storage.DeleteFile(context2.TODO(), testCase.volumeName, testCase.objectName)
		expectErr := (err != nil)
...
func testStorageAPIRenameFile(t *testing.T, storage StorageAPI) {
	...
	err = storage.MakeVol(context2.TODO(), "bar")
	if err != nil {
		t.Fatalf("unexpected error %v", err)
	}
	...
	err = storage.AppendFile(context2.TODO(), "foo", "otherobject", []byte("foo"))
	if err != nil {
		t.Fatalf("unexpected error %v", err)
	}
	...
	for i, testCase := range testCases {
		err := storage.RenameFile(context2.TODO(), testCase.volumeName, testCase.objectName, testCase.destVolumeName, testCase.destObjectName)
		expectErr := (err != nil)
