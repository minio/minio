...
func (z *BucketMetadata) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 14
	// write "Created"
	err = en.Append(0x8e, 0xa7, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64)
	if err != nil {
		return
	}
...
func (z *BucketMetadata) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 14
	// string "Created"
	o = append(o, 0x8e, 0xa7, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64)
...
func (z *BucketMetadata) Msgsize() (s int) {
	s = 1 + 8 + msgp.TimeSize + 5 + msgp.StringPrefixSize + len(z.Name) + 28 + msgp.BytesPrefixSize + len(z.BucketTargetsConfigMetaJSON) + 21 + msgp.BytesPrefixSize + len(z.ReplicationConfigXML) + 16 + msgp.BytesPrefixSize + len(z.QuotaConfigJSON) + 17 + msgp.BytesPrefixSize + len(z.TaggingConfigXML) + 20 + msgp.BytesPrefixSize + len(z.EncryptionConfigXML) + 20 + msgp.BytesPrefixSize + len(z.VersioningConfigXML) + 20 + msgp.BytesPrefixSize + len(z.ObjectLockConfigXML) + 19 + msgp.BytesPrefixSize + len(z.LifecycleConfigXML) + 22 + msgp.BytesPrefixSize + len(z.NotificationConfigXML) + 17 + msgp.BytesPrefixSize + len(z.PolicyConfigJSON) + 24 + msgp.BytesPrefixSize + len(z.BucketTargetsConfigJSON) + 12 + msgp.BoolSize
	return
}
