			...
			for za0001 := range z.Totals {
				...
				for zb0003 > 0 {
					...
					case "Totals":
						...
						if err != nil {
							err = msgp.WrapError(err, "Totals", za0001, "Totals")
							return
						}
						if zb0004 != uint32(60) {
							err = msgp.ArrayError{Wanted: uint32(60), Got: zb0004}
							return
						}
						for za0002 := range z.Totals[za0001].Totals {
							var zb0005 uint32
							zb0005, err = dc.ReadMapHeader()
							if err != nil {
								err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002)
								return
							}
							for zb0005 > 0 {
								zb0005--
								...
								switch msgp.UnsafeString(field) {
								case "Total":
									z.Totals[za0001].Totals[za0002].Total, err = dc.ReadInt64()
									if err != nil {
										err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002, "Total")
										return
									}
								case "N":
									z.Totals[za0001].Totals[za0002].N, err = dc.ReadInt64()
									if err != nil {
										err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002, "N")
										return
									}
								default:
									err = dc.Skip()
					...
					case "LastSec":
						z.Totals[za0001].LastSec, err = dc.ReadInt64()
						if err != nil {
							err = msgp.WrapError(err, "Totals", za0001, "LastSec")
							return
						}
					default:
						err = dc.Skip()
...
func (z *LastMinuteLatencies) EncodeMsg(en *msgp.Writer) (err error) {
	...
	for za0001 := range z.Totals {
		...
		for za0002 := range z.Totals[za0001].Totals {
			...
			err = en.WriteInt64(z.Totals[za0001].Totals[za0002].Total)
			if err != nil {
				err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002, "Total")
				return
			}
			...
			err = en.WriteInt64(z.Totals[za0001].Totals[za0002].N)
			if err != nil {
				err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002, "N")
				return
			}
		...
		err = en.WriteInt64(z.Totals[za0001].LastSec)
		if err != nil {
			err = msgp.WrapError(err, "Totals", za0001, "LastSec")
			return
		}
...
func (z *LastMinuteLatencies) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0001 := range z.Totals {
		...
		for za0002 := range z.Totals[za0001].Totals {
			...
			// string "Total"
			o = append(o, 0x82, 0xa5, 0x54, 0x6f, 0x74, 0x61, 0x6c)
			o = msgp.AppendInt64(o, z.Totals[za0001].Totals[za0002].Total)
			// string "N"
			o = append(o, 0xa1, 0x4e)
			o = msgp.AppendInt64(o, z.Totals[za0001].Totals[za0002].N)
		}
		// string "LastSec"
		o = append(o, 0xa7, 0x4c, 0x61, 0x73, 0x74, 0x53, 0x65, 0x63)
		o = msgp.AppendInt64(o, z.Totals[za0001].LastSec)
	}
	return
}
		...
		case "Totals":
			...
			for za0001 := range z.Totals {
				...
				for zb0003 > 0 {
					...
					case "Totals":
						...
						for za0002 := range z.Totals[za0001].Totals {
							...
							for zb0005 > 0 {
								...
								switch msgp.UnsafeString(field) {
								case "Total":
									z.Totals[za0001].Totals[za0002].Total, bts, err = msgp.ReadInt64Bytes(bts)
									if err != nil {
										err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002, "Total")
										return
									}
								case "N":
									z.Totals[za0001].Totals[za0002].N, bts, err = msgp.ReadInt64Bytes(bts)
									if err != nil {
										err = msgp.WrapError(err, "Totals", za0001, "Totals", za0002, "N")
										return
									}
					...
					case "LastSec":
						z.Totals[za0001].LastSec, bts, err = msgp.ReadInt64Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "Totals", za0001, "LastSec")
							return
						}
...
func (z *LastMinuteLatencies) Msgsize() (s int) {
	s = 1 + 7 + msgp.ArrayHeaderSize + (sizeLastElemMarker * (16 + (60 * (9 + msgp.Int64Size + msgp.Int64Size)) + msgp.Int64Size))
	return
}
