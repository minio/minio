...
// DecodeMsg implements msgp.Decodable
func (z *VersionSummary) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	...
	for zb0001 > 0 {
		...
		case "Versions":
			...
			if cap(z.Versions) >= int(zb0002) {
				...
				z.Versions = make([]xlMetaV2VersionHeader, zb0002)
			}
...
// EncodeMsg implements msgp.Encodable
func (z *VersionSummary) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "Versions"
...
// MarshalMsg implements msgp.Marshaler
func (z *VersionSummary) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "Versions"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *VersionSummary) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *VersionSummary) Msgsize() (s int) {
...
// DecodeMsg implements msgp.Decodable
func (z *VersionSummaryOpts) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "SkipFreeVersions":
			z.SkipFreeVersions, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "SkipFreeVersions")
				return
			}
		default:
			err = dc.Skip()
...
// EncodeMsg implements msgp.Encodable
func (z VersionSummaryOpts) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "SkipFreeVersions"
	err = en.Append(0x81, 0xb0, 0x53, 0x6b, 0x69, 0x70, 0x46, 0x72, 0x65, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73)
	if err != nil {
		return
	}
	err = en.WriteBool(z.SkipFreeVersions)
	if err != nil {
		err = msgp.WrapError(err, "SkipFreeVersions")
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z VersionSummaryOpts) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "SkipFreeVersions"
	o = append(o, 0x81, 0xb0, 0x53, 0x6b, 0x69, 0x70, 0x46, 0x72, 0x65, 0x65, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x73)
	o = msgp.AppendBool(o, z.SkipFreeVersions)
	return
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *VersionSummaryOpts) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "SkipFreeVersions":
			z.SkipFreeVersions, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "SkipFreeVersions")
				return
			}
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z VersionSummaryOpts) Msgsize() (s int) {
	s = 1 + 17 + msgp.BoolSize
	return
}
