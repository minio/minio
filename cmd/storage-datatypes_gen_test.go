...
func TestMarshalUnmarshalDriveFormatResult(t *testing.T) {
	v := DriveFormatResult{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgDriveFormatResult(b *testing.B) {
	v := DriveFormatResult{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgDriveFormatResult(b *testing.B) {
	v := DriveFormatResult{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalDriveFormatResult(b *testing.B) {
	v := DriveFormatResult{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeDriveFormatResult(t *testing.T) {
	v := DriveFormatResult{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeDriveFormatResult Msgsize() is inaccurate")
	}

	vn := DriveFormatResult{}
	err := msgp.Decode(&buf, &vn)
	if err != nil {
		t.Error(err)
	}
...
func BenchmarkEncodeDriveFormatResult(b *testing.B) {
	v := DriveFormatResult{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeDriveFormatResult(b *testing.B) {
	v := DriveFormatResult{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalDrivesFormatResp(t *testing.T) {
	v := DrivesFormatResp{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgDrivesFormatResp(b *testing.B) {
	v := DrivesFormatResp{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgDrivesFormatResp(b *testing.B) {
	v := DrivesFormatResp{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalDrivesFormatResp(b *testing.B) {
	v := DrivesFormatResp{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeDrivesFormatResp(t *testing.T) {
	v := DrivesFormatResp{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodeDrivesFormatResp Msgsize() is inaccurate")
	}
...
func BenchmarkEncodeDrivesFormatResp(b *testing.B) {
	v := DrivesFormatResp{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeDrivesFormatResp(b *testing.B) {
	v := DrivesFormatResp{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
