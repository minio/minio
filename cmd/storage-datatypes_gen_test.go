...
func TestMarshalUnmarshalPurgeState(t *testing.T) {
	v := PurgeState{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgPurgeState(b *testing.B) {
	v := PurgeState{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgPurgeState(b *testing.B) {
	v := PurgeState{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalPurgeState(b *testing.B) {
	v := PurgeState{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodePurgeState(t *testing.T) {
	v := PurgeState{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodePurgeState Msgsize() is inaccurate")
	}
...
func BenchmarkEncodePurgeState(b *testing.B) {
	v := PurgeState{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodePurgeState(b *testing.B) {
	v := PurgeState{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
