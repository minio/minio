...
func TestMarshalUnmarshaldataUsageEntryV8(t *testing.T) {
	v := dataUsageEntryV8{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgdataUsageEntryV8(b *testing.B) {
	v := dataUsageEntryV8{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgdataUsageEntryV8(b *testing.B) {
	v := dataUsageEntryV8{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshaldataUsageEntryV8(b *testing.B) {
	v := dataUsageEntryV8{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodedataUsageEntryV8(t *testing.T) {
	v := dataUsageEntryV8{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodedataUsageEntryV8 Msgsize() is inaccurate")
	}
...
func BenchmarkEncodedataUsageEntryV8(b *testing.B) {
	v := dataUsageEntryV8{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodedataUsageEntryV8(b *testing.B) {
	v := dataUsageEntryV8{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
