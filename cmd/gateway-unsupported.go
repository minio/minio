...
// ScannerAndGetDataUsage - scanner is not implemented for gateway
func (a GatewayUnsupported) ScannerAndGetDataUsage(ctx context.Context, bf *bloomFilter, updates chan<- DataUsageInfo) error {
