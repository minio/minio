...
func (a GatewayUnsupported) DeleteObjectVersion(ctx context.Context, bucket, object, version string) (deleteMarker bool, err error) {
...
func (a GatewayUnsupported) ListObjectVersions(ctx context.Context, bucket, prefix, delimiter, keyMarker, versionIDMarker string, maxKeys int) (result ListObjectsVersionsInfo, err error) {
