    ...
    return (
      <section className="browser__inner">
        ...
        <section className={ classNames({ 'content': true, 'content--toggled': sidebarStatus }) }>
          ...
          <aside className={ classNames ({ 'preview': true, 'preview--toggled': previewStatus }) }>
            ...
            <div className="preview__body">
              ...
              <div className="preview__actions">
                <button className="btn btn--lg btn--primary">Preview</button>
                <button className="btn btn--lg btn--primary">Download</button>
              </div>
            </div>
          </aside>
