...
func TestMarshalUnmarshalmuxMsg(t *testing.T) {
	v := muxMsg{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgmuxMsg(b *testing.B) {
	v := muxMsg{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgmuxMsg(b *testing.B) {
	v := muxMsg{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalmuxMsg(b *testing.B) {
	v := muxMsg{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodemuxMsg(t *testing.T) {
	v := muxMsg{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	...
	m := v.Msgsize()
	if buf.Len() > m {
		t.Log("WARNING: TestEncodeDecodemuxMsg Msgsize() is inaccurate")
	}
...
func BenchmarkEncodemuxMsg(b *testing.B) {
	v := muxMsg{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodemuxMsg(b *testing.B) {
	v := muxMsg{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
